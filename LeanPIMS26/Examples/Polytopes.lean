...
Q: What does the underscore stand for here?
-/
...
Shellability of Relative Squeezed Balls and Spheres - TODO: Citate properly.

https://arxiv.org/abs/2607.20717

<img src='img/VPolytope.png' class='img-down-left' width=40%></img> -- TODO: Change to QR code.

As a side project, I'm trying to formalize this result in Lean with the help of AI.

My Experience
===
- Mathlib lacks a lot of support in Combinatorics, so a lot of simple theorems in this field need to proven from scratch or sorried.
